$(function() {
    ...
    var initialize = function() {
        $("#mygame").append("<div id='container' style='display: none; width: 598px; height: 480px;'>");
        gf.addSprite("container","background",{width: 598, height: 480});
        gf.addSprite("container","packets1",{width: 598, height: 40, y: 400});
        gf.addSprite("container","packets2",{width: 598, height: 40, y: 330});
        gf.addSprite("container","packets3",{width: 598, height: 40, y: 260});
        gf.addSprite("container","bugs1",{width: 598, height: 60, y: 170});
        gf.addSprite("container","bugs2",{width: 598, height: 60, y: 100});
        gf.addSprite("container","bugs3",{width: 598, height: 60, y: 30});
        gf.addSprite("container","front",{width: 598, height: 480});
